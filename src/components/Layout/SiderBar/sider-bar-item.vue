...
<template>
  <div class="sider-bar-item-container">
    <div @click="toggle" :class="activeBg" :style="{paddingLeft: (level - 1) * 15 + 'px'}">
      <div class="sider-bar-item" @click="click">
        <div>
          <svg-icon v-if="model.meta.icon" class="icon" :icon="model.meta.icon" :class="activeCls"></svg-icon>
